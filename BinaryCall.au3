...
EndFunc   ;==>_BinaryCall_RegionSize
...
Func _BinaryCall_MemorySearch($Ptr, $Length, $Binary)
	...
	Return $Ret[0]
EndFunc   ;==>_BinaryCall_MemorySearch
...
EndFunc   ;==>_BinaryCall_Base64Decode
...
EndFunc   ;==>_BinaryCall_Base64Encode
...
EndFunc   ;==>_BinaryCall_LzmaDecompress
...
Func _BinaryCall_Relocation($Base, $Reloc)
	...
	Next
EndFunc   ;==>_BinaryCall_Relocation
...
Func _BinaryCall_ImportLibrary($Base, $Length)
	...
	Until $Length <= $JmpLen
	Return True
EndFunc   ;==>_BinaryCall_ImportLibrary
...
EndFunc   ;==>_BinaryCall_CodePrepare
...
EndFunc   ;==>_BinaryCall_SymbolFind
...
Func _BinaryCall_SymbolList($CodeBase, $Symbol)
	...
	Next
	Return $SymbolList
EndFunc   ;==>_BinaryCall_SymbolList
...
Func _BinaryCall_CommandLineToArgv($CommandLine, ByRef $Argc, $IsUnicode = False)
	...
	EndIf
EndFunc   ;==>_BinaryCall_CommandLineToArgv
...
Func __BinaryCall_ReleaseOnExit_Handle($Ptr = Default)
	...
	Else
		...
		EndIf
	EndIf
EndFunc   ;==>__BinaryCall_ReleaseOnExit_Handle
