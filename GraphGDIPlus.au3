...
; #CHANGES# =============================================================================
; Date 			Comment
; 2017.09.20	Add $iColor, $bReverse to fucntion  _GraphGDIPlus_Set_RangeX()
; 				Add $iColor, $iWidth, $iScaleFactor to function _GraphGDIPlus_Set_RangeY()
; =======================================================================================
...
; $iColor - [optional] color of label text
; $bReverse - [optional] reverse the order of labels
; =======================================================================================
Func _GraphGDIPlus_Set_RangeX(ByRef $aGraphArray, $iLow, $iHigh, $iXTicks = 1, $bLabels = 1, $iRound = 0, $iColor = 0x000000, $bReverse = False)
	If IsArray($aGraphArray) = 0 Then Return
	...
	If Not $bReverse Then
		For $i = 1 To $iXTicks + 1
			...
			$ahTicksLabelsX[$i] = GUICtrlCreateLabel("", _
					...
					$aGraphArray[3] + $aGraphArray[5] + 10, _
					$aGraphArray[4] / $iXTicks, _
					13, _
					1)
	...
	Else
		For $i = 1 To $iXTicks + 1
			ReDim $ahTicksLabelsX[$i + 1]
			$ahTicksLabelsX[$i] = GUICtrlCreateLabel("", _
					($aGraphArray[2] + (($aGraphArray[4] / $iXTicks) * ($iXTicks - $i + 1))) - (($aGraphArray[4] / $iXTicks) / 2), _
					$aGraphArray[3] + $aGraphArray[5] + 10, _
					$aGraphArray[4] / $iXTicks, _
					13, _
					1)
...
; $iRound - [optional] rounding level of label values
; $iColor - [optional] color of label text
; $iWidth - [optional] width of label
; $iScaleFactor - [optional] the value displayed in multiplied with this factor
; =======================================================================================
Func _GraphGDIPlus_Set_RangeY(ByRef $aGraphArray, $iLow, $iHigh, $iYTicks = 1, $bLabels = 1, $iRound = 0, $iColor = 0x000000, $iWidth = 30, $iScaleFactor = 1)
	If IsArray($aGraphArray) = 0 Then Return
	...
	For $i = 1 To $iYTicks + 1
		...
		$ahTicksLabelsY[$i] = GUICtrlCreateLabel("", _
				$aGraphArray[2] - $iWidth - 10, _
				($aGraphArray[3] + $aGraphArray[5]) - (($aGraphArray[5] / $iYTicks) * ($i - 1)) - 6, _
				$iWidth, _
				13, _
				2)
		GUICtrlSetBkColor(-1, -2)
	...
	If $bLabels = 1 Then
		For $i = 1 To (UBound($ahTicksLabelsY) - 1)
			GUICtrlSetData($ahTicksLabelsY[$i], StringFormat("%." & $iRound & "f", _GraphGDIPlus_Reference_Pixel("p", (($i - 1) * ($aGraphArray[5] / $iYTicks)), $aGraphArray[8], $aGraphArray[9], $aGraphArray[5]) / $iScaleFactor))
		Next
	EndIf
	;----- load created arrays back into array -----
